...
public class Homework7 {
    ...
    public static void main(String[] args) {
        ...
        if(select == 1) {
            ...
            if(type == 1) {
                ...
                System.out.print("Salary : "); int salary = input.nextInt();
            ...
            if(type == 2) {
                ...
                System.out.print("Name : "); String name = input.next();
                System.out.print("Hours Work : "); int hoursWork = input.nextInt();
            ...
            System.out.print("New Name : "); String name = input.next();
            emp.setName(name);
            
            System.out.print("New Salary : "); int salary = input.nextInt();
            emp.setSalary(salary);
            
            FulltimeTable.updateEmployee(emp);
        } else if (select == 3) {
            System.out.print("ID : "); Long id = input.nextLong();
    ...
    public static void persist(Object object) {
        EntityManagerFactory emf = Persistence.createEntityManagerFactory("Homework7PU");
